//
//  FansQuestionViewController.swift
//  a2zServis
//
...
class FansQuestionViewController: UIViewController {
    ...
    @IBAction func questionTwoTapped(_ sender: Any) {
        ...
        _ = alert.addButton("بله") {
            self.answerTwoLabel.text = "بله"
        }
        _ = alert.addButton("خیر") {
            self.answerTwoLabel.text = "خیر"
        }
    ...
    @IBAction func nextBttnTapped(_ sender: Any) {
        performSegue(withIdentifier: "showDateWorkVCTwo", sender: self)
    }
}
